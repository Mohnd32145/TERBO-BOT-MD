...
let fakegif = {key: {participant: `0@s.whatsapp.net`, ...('6289643739077-1613049930@g.us' ? {remoteJid: '6289643739077-1613049930@g.us'} : {})}, message: {'videoMessage': {'title': '𝑻𝑬𝑹𝑩𝑶〔⚡️〕𝑩𝑶𝑻', 'h': `Hmm`, 'seconds': '99999', 'gifPlayback': 'true', 'caption': '𝑻𝑬𝑹𝑩𝑶〔⚡️〕𝑬𝑳 𝑭𝑨𝑮𝑬𝑹', 'jpegThumbnail': false}}};
...
await conn.sendContact(m.chat, [[`201211060921` + `@s.whatsapp.net`, wm]], vn, {
 contextInfo: { 
 forwardingScore: 2023,
isForwarded: false, 
 externalAdReply: {  
 title: '↝|𝑻𝑬𝑹𝑩𝑶 𝑬𝑳 𝑮𝑨𝑴𝑬𝑫↝|', 
 body: '𝑻𝑬𝑹𝑩𝑶〔⚡️〕𝑩𝑶𝑻', 
 sourceUrl: 'https://whatsapp.com/channel/0029VaxrsAa5kg7EJfR5qU1f',
 thumbnail: vn2,
 thumbnailUrl: vn2, 
 mediaType: 1,
